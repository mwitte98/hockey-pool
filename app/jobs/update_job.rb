class UpdateJob
  ...
  def perform
    ...
    agent = Mechanize.new
    response = JSON.parse(agent.get('https://statsapi.web.nhl.com/api/v1/schedule?startDate=2020-08-01&endDate=2020-10-15&hydrate=linescore,scoringplays,decisions,game(seriesSummary)').body)
