class SettingsController < ApplicationController
  ...
  def setting_params
    params.permit(:is_playoffs_started, :min_centers, :max_centers, :min_wingers, :max_wingers, :min_defensemen,
                  ...
                  :points_otg, :points_wins, :points_otl, :points_shutouts, :points_finals_goals,
                  :points_finals_assists, :points_finals_gwg, :points_finals_shg, :points_finals_otg,
                  :points_finals_wins, :points_finals_otl, :points_finals_shutouts)
  end
end
